...
function FlightSearch() {
  ...
  console.log({ searchCount, lastSearchTime });
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-xs text-muted-foreground border-t pt-2">
          Debug: Search count: {searchCount.current}, Last search:{" "}
...
function BookingSummary() {
  ...
  const {
    ...
    return {
      formattedDepartureDate: depDate.toLocaleDateString("en-US", {
        month: "short",
        day: "numeric",
      }),
      formattedReturnDate: retDate.toLocaleDateString("en-US", {
        month: "short",
        day: "numeric",
      }),
      tripDuration: `${diffDays} days`,
      totalFlightCost: flightPrice * passengers,
      totalHotelCost: hotelPrice * diffDays,
      grandTotal: flightPrice * passengers + hotelPrice * diffDays + taxes,
    };
  }, [bookingData]);
